# Redteam pentest assessment comments

> [!NOTE]
> This is the legacy faststore pipeline test.
> Tag: `faststore-ga-01`



- Build step
  - /var/run/secrets -> `arn:aws:sts::558830342743:assumed-role/prd-sh-frontendcicd-eks-use1b-z64-cicd-tekton` 
  - has s3 permissions on the bucket for configuring vtex-sites builds and logs for other sites
- Cypress step
  - ec2 metadata -> `arn:aws:sts::558830342743:assumed-role/prd-sh-frontendcicd-eks-use1b-z64-node-role`
- Lighthouse step
  - ?
- SonarQube step
  - ?
- Final runtime
  - ec2 metadata -> `arn:aws:sts::558830342743:assumed-role/stg-sh-homebrew-eks-use1b-pan-node-role`


- [legacy faststore (tag-1) PPE entrypoints investigation](./execution-pings.md)
